...
const items = [
  {
    ...
    des: "Get concise summaries of the latest news articles, saving you time while keeping you informed.",
  },
  {
    id: 2,
    name: "News Aggregator",
    des: "Access a wide range of articles from various sources in one place, tailored to your interests.",
  },
  {
    id: 3,
    name: "Daily Recaps",
    des: "Receive daily summaries of significant events, ensuring you never miss crucial updates.",
  },
  {
    id: 4,
    name: "Curated Feed",
    des: "Enjoy a personalized news feed with content curated just for you based on your preferences.",
  },
];
